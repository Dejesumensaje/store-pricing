 ...
 * "Cost changes" / "Competitor moves" view lenses. Independent of Change
 * Reason (below) — a lens is just context that prompted the director to open
 * the item; the reason they attach to the resulting decision is its own,
 * separate pick.
 */
...
export type PricingItem = {
   ...
   * can carry both. Independent of Change Reason — see StoreChangeReason.
   */
